...
export function NotificationSettings({ phone }: NotificationSettingsProps) {
  ...
  return (
    <section className="card card--dark">
      <div className="section-title">Ative as notificações</div>
      ...
      {status === 'ios-needs-install' && (
        <p style={{ color: 'var(--color-text-muted)', marginTop: '0.5rem' }}>
          Para receber avisos no iPhone ou iPad, adicione este app à Tela de Início e abra por lá
      ...
      {status === 'disabled' && (
        <>
          <p style={{ color: 'var(--color-text-muted)', marginTop: '0.5rem' }}>
            Receba confirmações, alterações e lembretes dos seus agendamentos.
          </p>
